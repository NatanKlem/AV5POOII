...
CREATE TABLE `motoristas` (
  ...
  `nome_motoristas` varchar(100) NOT NULL,
  `nascimento_motoristas` varchar(14) NOT NULL,
  `cnh_motoristas` varchar(11) NOT NULL,
...
INSERT INTO `motoristas` VALUES (1,'Natan Klem','31/07/2003','00123456789');
...
-- Dump completed on 2021-06-28 16:51:40
